...
def goto_forest(health, end_dice, end_roll):
    ...
    print("If you would like to get closer press 0 or if you would like to go to the graveyard press 1")
    health = [1]
    print(health)
    ...
    if python_game == 0:
        ...
        if end_dice == 1:
            ...
            print("If you would like kill him press 0, or if you might like to let him alive press 1")
...
def goto_grave(health,key):
    ...
    print("Follow him = 0 , Look around = 1, Go back and go the forest = 2")
    grave2 = int(3)
    grave2 = int(input())
    if grave2 == 0:
        ...
        print("Remove helmet = 0 , Ignore his question and search the room = 1")
        grave3 = int(2)
        grave3 = int(input())
        if grave3 == 0:
        ...
        if grave3 == 1:
            ...
            if ipgame_result == 0:
                ...
                print("Great job, you succesfully opened the chest")
                print("A Key and a Healt Potion has been added to your inventory!\nHealt Potion increase your Healt Point by 1! Great job!" )
                key[0] = 1
                print("You earned a hp!")
                print(health)
                health[0] = health[0] + 1
...
def goto_village(health):
    ...
    print("Ready for war = 0 , Not ready for war= 1")
    vilage_dic = 2
